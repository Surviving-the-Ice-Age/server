...
public class GenerateTextController {
  private final TextGenerationDomainService textGenerationDomainService;
  ...
  public ResponseEntity<ApiResponseData<TextResponseDTO>> generateText(@RequestBody TextRequestDTO textRequestDTO){
    return ResponseEntity.ok().body(ApiResponseData.of(TEXT_GENERATION_SUCCESS.getCode(), TEXT_GENERATION_SUCCESS.getMessage(), textGenerationDomainService.generateText(textRequestDTO)));
  }
